...
(function ($) {
    ...
    // Update hidden quantity input before form submission
    ...
    proQty.on("click", ".qtybtn", function () {
        ...
        if ($button.hasClass("inc")) {
            ...
            if (oldValue > 1) {
                ...
                newVal = 1; // Ensure the quantity never goes below 1
            }
        }

        $button.parent().find("input").val(newVal);

        // Trigger the quantity update function
        updateQuantity($button.parent().find("input")[0]);
    });
