...
<head>
    ...
    <title>Login Admin Panel | Horanghae</title>
                        ...
                        <div class="w-full">
                            ...
                            <label class="block text-sm">
                                ...
                                <input
                                    ...
                                    placeholder="Your email" type="email" name="email" autocomplete="off" required
                                    autofocus @error('email') is-invalid @enderror value="{{ old('email') }}">
                            </label>
                            @error('email')
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="***************" type="password" name="password" autocomplete="off" required>
                            </label>
