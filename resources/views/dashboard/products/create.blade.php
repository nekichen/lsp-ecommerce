                    ...
                    <div class="mb-6">
                        <label class="block text-sm">
                            ...
                            <input type="file" name="image[]" id="image"
                                class="block w-full mt-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" multiple>
                    </div>
                    <div class="mb-6">
                        <label class="block text-sm">
